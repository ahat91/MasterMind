...
extern "C"
{
	...
	int _dequeueReusableCellWithIdentifierForIndexPath(int tag, const char * identifier, int * indexPath)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        
        if(tw)
        {
            return [MHTools getKeyFromActual:[tw dequeueReusableCellWithIdentifier:GetStringParamOrNil(identifier) forIndexPath:[MHTools convertJsonToIndexPath:indexPath]]];
        }
	...
	int _cellForRowAtIndexPath(int tag, int * indexPath)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        
        if(tw)
        {
            return [MHTools getKeyFromActual:[tw cellForRowAtIndexPath:[MHTools convertJsonToIndexPath:indexPath]]];
        }
	...
	void _scrollToRowAtIndexPathAtScrollPosition(int tag, int * indexPath, int scrollPosition, bool animated)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            [tw scrollToRowAtIndexPath:[MHTools convertJsonToIndexPath:indexPath] atScrollPosition:(UITableViewScrollPosition)scrollPosition animated:animated];
            return;
        }
	...
	void _selectRowAtIndexPath(int tag, int * indexPath, bool animated, int scrollPosition)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            [tw selectRowAtIndexPath:[MHTools convertJsonToIndexPath:indexPath] animated:animated scrollPosition:(UITableViewScrollPosition)scrollPosition];
            return;
        }
	...
	void _deselectRowAtIndexPath(int tag, int * indexPath, bool animated)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            [tw deselectRowAtIndexPath:[MHTools convertJsonToIndexPath:indexPath] animated:animated];
            return;
        }
	...
	void _moveRowAtIndexPathToIndexPath(int tag, int * indexPath, int * newIndexPath)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            
            [tw moveRowAtIndexPath:[MHTools convertJsonToIndexPath:indexPath] toIndexPath:[MHTools convertJsonToIndexPath:newIndexPath]];
            return;
        }
	...
	void _insertSectionsWithRowAnimation(int tag, int * sections, int animation)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            
            [tw insertSections:[MHTools convertArrayToNSIndexSet:sections] withRowAnimation:(UITableViewRowAnimation)animation];
            return;
        }
	...
	void _deleteSectionsWithRowAnimation(int tag, int * sections, int animation)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            
            [tw deleteSections:[MHTools convertArrayToNSIndexSet:sections] withRowAnimation:(UITableViewRowAnimation)animation];
            return;
        }
	...
	void _reloadSectionsWithRowAnimation(int tag, int * sections, int animation)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            
            [tw reloadSections:[MHTools convertArrayToNSIndexSet:sections] withRowAnimation:(UITableViewRowAnimation)animation];
            return;
        }
	...
	const char * _rectForRowAtIndexPath(int tag, int * indexPath)
	{
		UITableView *tw = [MHTools getActualObject:tag];
        if(tw)
        {
            
            return [MHTools convertCGRectToRect:[tw rectForRowAtIndexPath:[MHTools convertJsonToIndexPath:indexPath]]];
        }
