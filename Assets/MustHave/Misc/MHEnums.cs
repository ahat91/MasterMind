...
public enum MHTableViewStyle
{
	MHTableViewStylePlain,
	MHTableViewStyleGrouped
}

public enum MHTableViewScrollPosition
{
	MHTableViewScrollPositionNone,
	MHTableViewScrollPositionTop,
	MHTableViewScrollPositionMiddle,
	MHTableViewScrollPositionBottom
}

public enum MHTableViewRowAnimation
{
	MHTableViewRowAnimationFade,
	MHTableViewRowAnimationRight,
	MHTableViewRowAnimationLeft,
	MHTableViewRowAnimationTop,
	MHTableViewRowAnimationBottom,
	MHTableViewRowAnimationNone,
	MHTableViewRowAnimationMiddle,
	MHTableViewRowAnimationAutomatic = 100
}

public enum MHTableViewCellSeperatorStyle
{
	MHTableViewCellSeperatorStyleNone,
	MHTableViewCellSeperatorStyleSingleLine,
	MHTableViewCellSeperatorStyleSingleLineEtched
}

public enum MHTableViewCellStyle
{
	MHTableViewCellStyleDefault,
	MHTableViewCellStyleValue1,
	MHTableViewCellStyleValue2,
	MHTableViewCellStyleSubtitle
}

public enum MHTableViewCellSelectionStyle
{
	MHTableViewCellSelectionStyleNone,
	MHTableViewCellSelectionStyleBlue,
	MHTableViewCellSelectionStyleGray,
	MHTableViewCellSelectionStyleDefault
}

public enum MHTableViewCellEditingStyle
{
	MHTableViewCellEditingStyleNone,
	MHTableViewCellEditingStyleDelete,
	MHTableViewCellEditingStyleInsert
}

public enum MHTableViewCellAccessoryType
{
	MHTableViewCellAccessoryNone,
	MHTableViewCellAccessoryDisclosureIndicator,
	MHTableViewCellAccessoryDetailDisclosureButton,
	MHTableViewCellAccessoryCheckmark,
	MHTableViewCellAccessoryDetailButton
}

public enum MHTableViewCellStateMask
{
	MHTableViewCellStateDefaultMask                     = 0,
	MHTableViewCellStateShowingEditControlMask          = 1 << 0,
	MHTableViewCellStateShowingDeleteConfirmationMask   = 1 << 1
}

public enum MHTouchPhase
{
	MHTouchPhaseBegan,
	MHTouchPhaseMoved,
	MHTouchPhaseStationary,
	MHTouchPhaseEnded,
	MHTouchPhaseCancelled
}

public enum MHEventType
{
	MHEventTypeTouches,
	MHEventTypeMotion,
	MHEventTypeRemoteControl
}

public enum MHEventSubtype
{
	MHEventSubtypeNone                              = 0,
	
	MHEventSubtypeMotionShake                       = 1,
	
	MHEventSubtypeRemoteControlPlay                 = 100,
	MHEventSubtypeRemoteControlPause                = 101,
	MHEventSubtypeRemoteControlStop                 = 102,
	MHEventSubtypeRemoteControlTogglePlayPause      = 103,
	MHEventSubtypeRemoteControlNextTrack            = 104,
	MHEventSubtypeRemoteControlPreviousTrack        = 105,
	MHEventSubtypeRemoteControlBeginSeekingBackward = 106,
	MHEventSubtypeRemoteControlEndSeekingBackward   = 107,
	MHEventSubtypeRemoteControlBeginSeekingForward  = 108,
	MHEventSubtypeRemoteControlEndSeekingForward    = 109,
}
#endregion