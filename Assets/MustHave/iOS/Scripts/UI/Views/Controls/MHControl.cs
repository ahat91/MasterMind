...
public partial class MHControl : MHView {
	#region functions
	...
	public void addActionForControlEvents(Action<MHControl> action, MHControlEvents controlEvents)
	{
		MHiOSManager.Instance.addActionForControlEvents(tag, action, controlEvents);
	}
	
	public void addActionForControlEvents(Action<MHControl, MHEvent> action, MHControlEvents controlEvents)
	{
		MHiOSManager.Instance.addActionForControlEvents(tag, action, controlEvents);
	}
